...
Gerar um relatório estruturado. Para isso, utilize obrigatoriamente como base o template de relatório localizado em:

> [!TIP]
> Use o template: [architecture-report.md](file:///c:/Users/ricar/OneDrive/Área de Trabalho/dotnet-engineering-skills-pack/.github/skills/architecture-reviewer/templates/architecture-report.md)

Preencha o relatório com as seções a seguir:
